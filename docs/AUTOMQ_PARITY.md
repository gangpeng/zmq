...
- S3 WAL/object storage paths exist, but full AutoMQ S3Stream lifecycle
  ...
  entities, f64 quota values, compact record bytes, transaction filters/results,
