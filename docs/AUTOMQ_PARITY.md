...
end-offset visibility, DeleteRecords low-watermark visibility, and
DescribeTopicPartitions generated topic metadata through the same controller
failover, controller restart, and broker restart checkpoints. It now also
