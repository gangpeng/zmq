...
- Status: Source-level protocol audit tests now parse the generated index and
  ...
  topic-partition echoes, and map stale member epochs/static instance conflicts
  to KIP-848
