...
- Controller-style KV/node/router/license/node-id/group mutations now have a
  ...
  PutKVs/DeleteKVs now use a durable AutoMQ metadata snapshot boundary and roll
  back visible KV changes when that write fails. Single-node leaders now
