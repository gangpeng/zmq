...
ShareAcknowledge, and advances the same share-session epoch through both APIs at
each checkpoint. It now also sends live grouped OffsetFetch v8 requests covering a
