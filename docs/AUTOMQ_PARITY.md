...
- Controller-style KV/node/router/license/node-id/group mutations now have a
  ...
  AutoMQ metadata and object snapshot records. Remaining gap: add multi-node
  failover compatibility tests.
