...
- Status: local partition offset/HW/LSO snapshots now reload across restart and
  ...
  marker state updates, or log-dir estimates through fixed-size formatted
  partition keys; broker tick now enforces each group's configured session
