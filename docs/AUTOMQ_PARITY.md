...
a listed WAL object is missing during GET and can retry cleanly, and DeleteTopics
partition cleanup removes known local partition state without heap key
formatting.
