...
- Controller-style KV/node/router/license/node-id/group mutations now have a
  ...
  AutoMQ metadata records. Remaining gap: add multi-node failover compatibility
  tests.
