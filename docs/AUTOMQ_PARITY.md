...
and deletes a dedicated consumer-group offset, then verifies the OffsetDelete
tombstone remains visible as a missing committed offset after controller
network-partition phases, controller leader kill/election, old-leader fresh
rejoin, surviving-controller restart, and broker restart.
