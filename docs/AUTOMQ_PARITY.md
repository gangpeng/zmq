...
- Status: local partition offset/HW/LSO snapshots now reload across restart and
  ...
  snapshot writes fail, InitProducerId, AddPartitionsToTxn, and AddOffsetsToTxn
  now restore the previous transaction snapshot when their coordinator
