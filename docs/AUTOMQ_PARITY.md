...
- S3 WAL/object storage paths exist, but full AutoMQ S3Stream lifecycle
  ...
  compact record bytes, transaction filters/results, flexible encodings, and
  tagged-field terminators.
