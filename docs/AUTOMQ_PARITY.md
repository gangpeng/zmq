...
- Add chaos tests for SIGKILL, network partition, S3 outage, clock skew, and
  ...
  `ZMQ_S3_<PROFILE>_RUN_LIVE_OUTAGE=1`. Remaining work: broader
  multi-broker/controller partition matrices and scheduled live provider
  outage CI profiles.
