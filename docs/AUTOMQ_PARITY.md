...
- Validate rack-aware routing and auto-balancer decisions under load. Status:
  ...
  fence local Produce/Fetch when ownership is non-local. Controller-driven
  orchestration and live load/scale gates remain.
