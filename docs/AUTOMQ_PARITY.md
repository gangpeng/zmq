...
committed and aborted transactions through controller leader kill/election,
old-leader fresh rejoin, surviving-controller restart, and broker restart.
