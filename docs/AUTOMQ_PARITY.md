...
| Kafka generated schemas | Broad. 110 request schemas generated. Default-value serialize/deserialize/calcSize smoke tests now cover all 230 generated top-level request/response/header/record types across common protocol versions 0-20. Representative non-default golden wire fixtures now cover generated request headers plus MetadataRequest, ProduceRequest, ApiVersionsResponse, and CreateTopicsRequest across legacy and first-flexible encodings. | Extend non-default field fixtures, min/max/first-flexible semantic vectors, and golden wire fixtures to every generated request/response pair. |
