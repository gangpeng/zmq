...
- AlterReplicaLogDirs is now advertised and handled through generated request
  ...
  using the broker registration epoch and configured directory ID.
...
mutations through controller failover, controller restarts, and broker restart.
