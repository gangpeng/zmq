...
- S3 WAL/object storage paths exist, but full AutoMQ S3Stream lifecycle
  ...
  v0, ConsumerGroupDescribe v0, OffsetCommit v1/v8, DescribeTransactions v0,
  and ListTransactions v1 request/response golden fixtures now pin
  schema-shape transitions, nested compact arrays, nullable compact strings,
  UUID fields, share acknowledgement/state batches, commit timestamps/member
  epochs/static member identity, compact record bytes, transaction
