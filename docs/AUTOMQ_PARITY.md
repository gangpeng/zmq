...
durable after controller network-partition phases, controller leader
kill/election, old-leader fresh rejoin, surviving-controller restart, and
broker restart.
