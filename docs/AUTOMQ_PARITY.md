...
- Status: local partition offset/HW/LSO snapshots now reload across restart and
  ...
  and abort-after-complete failure. Remaining durability work is live
  MinIO/provider crash-fault recovery, provider-specific multipart faults, and
  crash/fault recovery against quorum/controller metadata.
