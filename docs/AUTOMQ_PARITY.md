...
- Status: local partition offset/HW/LSO snapshots now reload across restart and
  ...
  atomic WriteTxnMarkers S3 WAL objects now restore both marker partition
  offsets and completed transaction snapshots after fresh-dir replacement;
