...
- S3 WAL/object storage paths exist, but full AutoMQ S3Stream lifecycle
  ...
  v0, DescribeTransactions v0, and ListTransactions v1 request/response golden
  fixtures now pin schema-shape transitions, nested compact arrays, UUID
  fields, share acknowledgement/state batches, compact record bytes,
