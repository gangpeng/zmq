...
- Status: local partition offset/HW/LSO snapshots now reload across restart and
  ...
  `ZMQ_S3_PROVIDER_REQUIRED_MULTIPART_FAULT_PROFILES`, and optional
  ...
  scripts and live provider outage/fault recovery against quorum/controller
  metadata.
