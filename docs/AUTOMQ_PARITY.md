...
- Status: local partition offset/HW/LSO snapshots now reload across restart and
  ...
  snapshot writes fail, InitProducerId now restores the previous transaction
  snapshot when producer allocation cannot be written to shared storage, and
