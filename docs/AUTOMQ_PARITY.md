...
| Kafka generated schemas | Broad. 110 request schemas generated. Default-value serialize/deserialize/calcSize smoke tests now cover all 230 generated top-level request/response/header/record types at versions 0/1/2. | Add non-default field fixtures, min/max/first-flexible semantic vectors, and golden wire fixtures for every generated request/response pair. |
...
- Status: Source-level protocol audit tests now parse the generated index and
  ...
  deserialize, and calcSize for all 230 generated top-level messages at versions
  0/1/2. DescribeLogDirs now uses generated request/response schemas across
