...
- Status: Source-level protocol audit tests now parse the generated index and
  ...
  acquired-record ranges, validate acknowledgement batches, and advance local
  share start offsets.
