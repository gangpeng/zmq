...
- AlterReplicaLogDirs is now advertised and handled through generated request
  ...
  restart. Delegation-token APIs 38-41 are advertised with strict
...
AlterReplicaLogDirs v2 partition directory mutation through controller
failover, controller restarts, and broker restart.
