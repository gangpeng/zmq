...
- Controller-style KV/node/router/license/node-id/group mutations now have a
  ...
  Java kafka-clients, and Go kafka-go clients. Remaining gap: broaden versioned
  client fixtures.
...
- Add compatibility runs with Java, librdkafka, Go, Python, and Kafka CLI
  ...
  kafka-go. Remaining work: run the matrix across explicit client/library
  version sets in CI.
