...
- Validate rack-aware routing and auto-balancer decisions under load. Status:
  ...
  has simulated convergence coverage after ownership changes. Live
  multi-process load/scale gates remain.
