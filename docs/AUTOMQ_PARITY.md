...
- Status: Source-level protocol audit tests now parse the generated index and
  ...
  durable topic snapshot succeeds, so failed snapshot writes restore topic
  visibility without dropping those side states.
