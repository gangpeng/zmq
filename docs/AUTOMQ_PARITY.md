...
- Status: local partition offset/HW/LSO snapshots now reload across restart and
  ...
  windows in addition to response body length so provider range mismatches fail
