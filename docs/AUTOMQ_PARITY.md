...
- Controller-style KV/node/router/license/node-id/group mutations now have a
  ...
  client/library version sets. Remaining gap: broaden transactional,
  rebalance, and admin semantic client fixtures.
...
- Add compatibility runs with Java, librdkafka, Go, Python, and Kafka CLI
  ...
  Python interpreters, tool lists, and bootstrap endpoints. Remaining work:
  add deeper transactional, rebalance, ACL/security, and admin semantic client
  fixtures.
