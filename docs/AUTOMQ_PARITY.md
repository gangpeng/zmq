...
- Prepared-object lifecycle coverage includes request-TTL tracking, registry-only
  ...
  compaction cleanup paths. Local-mode CreateStreams and PrepareS3Object now
  use a durable ObjectManager snapshot boundary and roll back visible stream or
  prepared-object changes when that write fails.
