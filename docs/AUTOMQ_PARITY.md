...
- S3 WAL/object storage paths exist, but full AutoMQ S3Stream lifecycle
  ...
  Latest default-suite protocol tranche: generated ListTransactions v1
  request/response golden fixtures now pin state filters, producer-id filters,
  duration filters, unknown-state filters, transaction states, flexible compact
