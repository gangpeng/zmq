...
DescribeCluster v1 broker/controller endpoint views plus DescribeConfigs v4
topic-config views and DescribeLogDirs v4 partition log-dir views through
controller failover, controller restarts, and broker restart.
...
controller failover, controller restart, and broker restart checkpoints. It now also
produces an idempotent batch before failover and verifies DescribeProducers
