...
- Broader live load/scale orchestration, cross-broker chaos, scheduled live
  provider outage profiles, and comparative Kafka/AutoMQ performance trend
  gates are still release blockers.
