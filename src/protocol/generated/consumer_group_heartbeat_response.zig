// Auto-generated from ConsumerGroupHeartbeatResponse.json
// API Key: 68, Type: response
...
pub const ConsumerGroupHeartbeatResponse = struct {
    ...
    pub fn deserialize(alloc: Allocator, buf: []const u8, pos: *usize, version: i16) !ConsumerGroupHeartbeatResponse {
        var result = ConsumerGroupHeartbeatResponse{};
    ...
    pub fn calcSize(self: *const ConsumerGroupHeartbeatResponse, version: i16) usize {
        var size: usize = 0;
        size += 4;
        size += 2;
