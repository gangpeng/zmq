// Auto-generated from AssignReplicasToDirsResponse.json
// API Key: 73, Type: response
...
pub const AssignReplicasToDirsResponse = struct {
    ...
    pub fn serialize(self: *const AssignReplicasToDirsResponse, buf: []u8, pos: *usize, version: i16) void {
    ...
    pub fn deserialize(alloc: Allocator, buf: []const u8, pos: *usize, version: i16) !AssignReplicasToDirsResponse {
        var result = AssignReplicasToDirsResponse{};
    ...
    pub fn calcSize(self: *const AssignReplicasToDirsResponse, version: i16) usize {
        var size: usize = 0;
        size += 4;
        size += 2;
