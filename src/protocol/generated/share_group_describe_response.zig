// Auto-generated from ShareGroupDescribeResponse.json
// API Key: 77, Type: response
...
pub const ShareGroupDescribeResponse = struct {
    ...
    pub fn serialize(self: *const ShareGroupDescribeResponse, buf: []u8, pos: *usize, version: i16) void {
    ...
    pub fn deserialize(alloc: Allocator, buf: []const u8, pos: *usize, version: i16) !ShareGroupDescribeResponse {
        var result = ShareGroupDescribeResponse{};
    ...
    pub fn calcSize(self: *const ShareGroupDescribeResponse, version: i16) usize {
        var size: usize = 0;
        size += 4;
